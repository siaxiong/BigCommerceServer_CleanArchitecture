...
public class BC_ShippingAddress : AddressBase
{
  ...
  public BC_ShippingAddress(int id, int order_id, string first_name,
  ...
  public BC_ShippingAddress(int id, int order_id, string first_name,
    string last_name, string company, string street_1, string street_2,
    string city, string zipcode, string state, string country, string email,
    string phone, int items_total, string shipping_method, string cost_ex_tax)
    : base(street_1, city, state, zipcode, country)
  {
    this.id = id;
    this.order_id = order_id;
    this.first_name = first_name;
